                        ...
                        <td class="text-center">
                            <div class="flex items-center justify-center gap-1.5">
                                ...
                                <form action="{{ route('usuarios.toggleEstado', $usuario) }}"
                                    ...
                                    @csrf @method('PATCH')
                                    <button type="submit"
                                        class="w-8 h-8 rounded-lg {{ $usuario->estado === 'activo' ? 'bg-slate-100 text-slate-600 hover:bg-slate-200' : 'bg-blue-50 text-blue-600 hover:bg-blue-100' }} hover:scale-105 transition-all flex items-center justify-center shadow-sm"
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                ...
                <div>
                    ...
                    <input type="password" name="password" required minlength="6"
                        ...
                        class="w-full px-4 py-2.5 rounded-xl border border-slate-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 outline-none transition text-sm placeholder-slate-400">
                </div>
